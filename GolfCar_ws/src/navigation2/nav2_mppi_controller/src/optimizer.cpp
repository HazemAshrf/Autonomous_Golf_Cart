  ...
  const nav_msgs::msg::Path & plan, nav2_core::GoalChecker * goal_checker)
{
  ...
  control.twist.linear.x = 3.5 * control.twist.linear.x;
  //if (control.twist.linear.x < 0.0) {
  //  control.twist.angular.z = 3.0 * control.twist.angular.z;
  //  control.twist.linear.x = 0.3 * control.twist.linear.x;
  //}
  //else{
  //  control.twist.linear.x = 2.5 * control.twist.linear.x;
  //}
