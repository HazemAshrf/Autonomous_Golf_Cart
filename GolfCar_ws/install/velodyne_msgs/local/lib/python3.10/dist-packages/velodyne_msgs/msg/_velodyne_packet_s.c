...
bool velodyne_msgs__msg__velodyne_packet__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("velodyne_msgs.msg._velodyne_packet.VelodynePacket", full_classname_dest, 49) == 0);
  }
  velodyne_msgs__msg__VelodynePacket * ros_message = _ros_message;
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of VelodynePacket */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("velodyne_msgs.msg._velodyne_packet");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VelodynePacket");
  ...
  {  // data
    ...
    memcpy(dst, src, 1206 * sizeof(uint8_t));
    Py_DECREF(field);
  }
